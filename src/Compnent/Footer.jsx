...
<div class="flex lg:col-span-2 flex-col lg:justify-start lg:items-start justify-center items-center space-y-4 w-full">
    ...
    <div class="lg:flex flex-col  hidden space-y-2">
        ...
        <div className="flex gap-4">
            <a href="https://www.facebook.com/riskrice" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.linkedin.com/company/riskrice/" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://wa.me/201040966755" target="_blank" rel="noopener noreferrer">
