...
<div className="flex lg:col-span-2 flex-col lg:justify-start lg:items-start justify-center items-center space-y-4 w-full">
    ...
    <div className="lg:flex flex-col  hidden space-y-2">
        ...
        <Link className="hover:underline hover:text-secondary underline-offset-4" href="/services" data-discover="true">{t('footer.b')}</Link>
        <Link className="hover:underline hover:text-secondary underline-offset-4" href="/services" data-discover="true">{t('footer.c')}</Link>
        <Link className="hover:underline hover:text-secondary underline-offset-4" href="/services" data-discover="true">{t('footer.d')}</Link>
        <Link className="hover:underline hover:text-secondary underline-offset-4" href="/services" data-discover="true">{t('footer.e')}</Link>
        </div>
        ...
        <Link className="hover:underline hover:text-secondary underline-offset-4"  href="/about" data-discover="true">{t('footer.g')}</Link>
        <Link className="hover:underline hover:text-secondary underline-offset-4" href="/services" data-discover="true">{t('Navbar.services')}</Link>
        </div>
